...
νℓкуяє.exec(`${νℓкуяє.pathFFmpeg} -i ${media} -af"aresample=48000,asetrate=48000*0.8" ${random}.mp3`,
async (error) => {
return νℓкуяє.reply(`*🕊️You:* ${νℓкуяє.pushname || "ɴᴏ_ɴᴀᴍᴇ"}\n*📢ID:* ${νℓcнαт.chat}
